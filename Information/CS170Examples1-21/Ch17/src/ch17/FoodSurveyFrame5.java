...
//Application frame:  Use of JPopupMenu, JMenu, L&F, GridBagLayout, JLabel, JCheckBox, JRadioButton, JTextArea and event handling
...
private void createGUIComponents() {
	  ...
	  hamburgerItem = new JMenuItem("Hambugger");
	  ...
	  dHamburgerItem = new JMenuItem("Hambugger");
	  ...
	  selectPanel.setBorder(BorderFactory.createTitledBorder(loweredBorder, "Select food you like or dislike: "));
		  ...
		  hamburgerBox = new JCheckBox("Hamburgger");
   ...
   displayTextArea.setVisible(false);
     ...
     addMouseListener(new MouseAdapter(){				//Use of Mouse adapter for popup menu
...
private void updateTextArea() {
	  String info = "\tLike\tDislike\n"
	  	  	   ...
	  	  	   + "Burgger\t" + hamburgerLikeCount + "\t" + hamburgerDislikeCount + "\n"
